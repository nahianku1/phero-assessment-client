...
import { Link, Outlet, useRouteContext, createFileRoute, useRouter, redirect } from '@tanstack/react-router';
  ...
  return (
    <div className="flex h-screen bg-gray-50">
              ...
              {[
                ...
                <li key={to}>
                  <Link
                    ...
                    activeProps={{ className: 'bg-gray-700 text-white rounded-xl' }}
                  >
      ...
      <Sheet>
        ...
        <SheetContent side="left" className="w-64 p-0 bg-gradient-to-b from-gray-900 to-gray-800 text-white">
          <nav className="mt-8">
            <ul className="space-y-4">
              {[
